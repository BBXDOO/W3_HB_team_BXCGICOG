...
# Representative synthetic PR profiles for benchmarking
BENCHMARK_PROFILES = [
    {
        "name": "tiny-fix",
...
def format_benchmark_report(results):
    ...
    lines = [
        ...
        f"_Generated: {ts}_",
        "",
        "| Profile | Files | Changes | Mode | Score | State |",
        "| --- | --- | --- | --- | --- | --- |",
    ]
...
if __name__ == "__main__":
    ...
    with open("/tmp/iget_benchmark.json", "w") as fh:
        json.dump(results, fh, indent=2, ensure_ascii=False)
    print("\nJSON saved to /tmp/iget_benchmark.json")
