...
- BBX19 : Announcements
  ขออนุญาติ กล่าวคำขอโทษต่อทีมงาน ,โมดูล ,และกิจกรรมทุกภาคส่วน ผม BBX19 มีภารกิจหลายอย่างที่จำเป็นต้องผลักดันในตอนนี้ แม้แต่โครงการส่วนตัวก็ต้องเลื่อนออกไปอย่างไร้เงื่อนไข..  ผมกำลังผลักดัน 2 โครงการนี้ เพราะความเชื่อมโยงและอ้างอิงกัน คือ
1. Table - W3X : โปรแกรมสร้างตารางแบบอ้างอิง Area.
2. W3.Lgu : ภาษาใหม่ที่เป็นของเรา ที่นี่ และมีผลในอนาคต.
ทั้ง 2 โครงการต้องการเวลา และสมาธิค่อนข้างมาก ,ละเอียดและซับซ้อน ขอทุกๆท่านเห็นใจผมด้วย โดยเฉพาะขีดจำกัดของผมเองซึ่งทุกๆท่านน่าจะทราบอยู่แล้ว
.. ทุกๆ 3 หรือ 7 วัน ผมจะเเวะมาบ้างทำอะไรเล็กๆน้อยๆ จนกว่า โครงการจะนิ่ง ผมจะกลับมาเพื่อดำเนินการขั้นต่อไปสำหรับที่นี่อีกครั้ง.  ขอบคุณที่เข้าใจภาระนี้ของผมครับเพราะ 2 สิ่งที่ผมทำอยู่นี้ จะสะท้อน ว่า คนที่ไม่เคยเรียนรู้วิทยาการด้านนี้ ,เริ่มจาก 0 ,ไม่เข้าใจภาษาโปรแกรมใดๆ นั้น ได้เรียนรู้ สิ่งใดจากที่นี่บ้าง ,นำมันไปใช้อย่างไร ,มันเกิดการเรียนรู้จริงหรือไม่ ..เป็นการพิศูจน์ตัวเองอีกครั้งครับ....    ขอบคุณทุกๆสิ่งที่เดินเคียงข้างผมมาถึงตรงนี้..    [BBX19]
