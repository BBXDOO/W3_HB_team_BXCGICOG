...
This repository uses the Module Manifest Standard so every agent/module can be discovered and audited without moving files.

**Allowed manifest locations:**
- `<AgentName>/module.json`
- `<AgentName>/modules/<AgentName>/module.json`

**Canonical search patterns (tools/scanners must support):**
- `*/module.json`
- `*/modules/*/module.json`
...
- `/modules` — module assets live here; manifests follow the **Module Manifest Standard** (see above)
