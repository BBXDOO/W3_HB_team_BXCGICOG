...
โครงสร้างใหม่สำหรับโมดูลมาตรฐานกลางของระบบ W3 (version 2026)
    protocol : ในบริบทนี้มิได้มีความหมายตามสากลหากแต่ใช้อ้างถึง ความเป็นคอนเซบของระบบที่ได้ถูกออกแบบมาอย่างเฉพาะเจาะจงโดยใช้ชื่อนี้เป็นศูนย์กลางของ prototype ของระบบย่อยใน W3 
