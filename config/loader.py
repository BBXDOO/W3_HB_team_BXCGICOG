...
def validate_w3_config(bundle: W3ConfigBundle) -> list[str]:
    ...
    for key in ("W3Lgu", "PX", "W3DB_append_flow", "EP_SIGNAL", "EP_SIGNAL_RYTM", "Hospitication", "W3_API", "Codex"):
    ...
    for required in ("Codex", "Hospitication", "W3Lgu", "PX", "W3DB_APPEND", "W3-API", "EP_SIGNAL", "EP_SIGNAL_RYTM", "IGET"):
